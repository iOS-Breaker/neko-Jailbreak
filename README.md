...
NekoJB is a semi-untethered jailbreak based on the kfd exploit, designed for arm64 devices (older than A12) running iOS 15 - iOS 18.5 beta 4. It supports both online and PC-based methods, allowing users to jailbreak their iPhones and iPads conveniently.
...
iOS 18.5 beta 4 - iOS 15 (including all sub-versions).<br><br>
